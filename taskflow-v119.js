...
.tf119-scroll{flex:1 1 auto!important;min-height:0!important;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior-y:contain!important;touch-action:pan-y!important;padding:14px 14px 185px!important;scrollbar-width:thin;scrollbar-color:#27d8cd rgba(255,255,255,.04)}
...
.tf119-note{margin:14px 0 10px;padding:12px 13px;border-radius:13px;border:1px solid rgba(139,99,255,.14);background:rgba(139,99,255,.055);font-size:10px;line-height:1.55;color:#a2aec0;white-space:normal!important;overflow:visible!important}.tf119-done{width:100%;margin:0}
#tf503020Hub.tf119-off{display:none!important}#tfPairV117.tf119-empty{display:none!important}#tfPairV117.tf119-single{grid-template-columns:1fr!important}
@media(max-width:430px){#tfManagerV117.tf119-modal{padding:8px 9px 112px!important}.tf119-sheet{max-height:calc(100dvh - 128px)!important;border-radius:21px!important}.tf119-head{padding:15px 14px 12px!important}.tf119-head h2{font-size:25px}.tf119-scroll{padding:12px 12px 190px!important}.tf119-actions{grid-template-columns:1fr}.tf119-row{padding:12px 11px!important}}
`;
